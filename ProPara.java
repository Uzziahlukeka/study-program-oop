    ...
    public static void main(String[] args) {  
        ...
        if (number==1){
            ...
            try{
                ...
                switch (choix) {
                    case 1 -> {
                        ...
                        do{
                            ...
                            switch (chaise){
                                case 0: vip.whereismytable();
                                case 1: System.out.println("Thank you for your confirmation!");
                ...
                System.out.println("Please type number 0-3");
            }
